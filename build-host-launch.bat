...
set "DEPLOY_DIR=%ROOT_DIR%tp-net-host-launch"
...
echo %GREEN%[OK]%RESET% Deployed to: tp-net-host-launch\
...
echo %GREEN%===============================================%RESET%
echo.
echo %CYAN%[INFO]%RESET% Output: tp-net-host-launch\%APP_NAME%.exe
echo.
